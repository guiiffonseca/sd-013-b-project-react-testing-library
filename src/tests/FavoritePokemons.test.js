...
describe('FavoritePokemeons.js', () => {
  it('should show \'No favorite pokemon found\' message if there is no favorite pokemons',
    () => {
  ...
  it('should show all cards of the favorite pokemons', () => {
    const testPokemons = [
      {
        id: 25,
        name: 'Pikachu',
