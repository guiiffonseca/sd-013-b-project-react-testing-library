...
describe('1. Teste o componente <App.js />', () => {
  test(`Teste se o topo da aplicação contém um conjunto fixo de links de navegação: Home,
  ...
  test(`Teste se a aplicação é redirecionada para a página inicial, na URL / ao clicar no
